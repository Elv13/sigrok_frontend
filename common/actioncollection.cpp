...
#define SELF &QAction::triggered, d_ptr, &ActionCollectionPrivate
    ...
    d_ptr->m_ZoomIn->setIcon(QIcon::fromTheme("zoom-in"));
    parent->actionCollection()->addAction("zoom-in", d_ptr->m_ZoomIn);
    ...
    d_ptr->m_ZoomOut->setIcon(QIcon::fromTheme("zoom-out"));
    parent->actionCollection()->addAction("zoom-out", d_ptr->m_ZoomOut);
    ...
    d_ptr->m_ZoomFit->setIcon(QIcon::fromTheme("zoom-fit-best"));
    parent->actionCollection()->addAction("zoom-fit", d_ptr->m_ZoomFit);
    connect(d_ptr->m_ZoomFit, SELF::slotZoonFit);

    d_ptr->m_ZoomReset = new QAction(parent);
    d_ptr->m_ZoomReset->setText(tr("Reset zoom"));
    d_ptr->m_ZoomReset->setIcon(QIcon::fromTheme("zoom-page"));
    parent->actionCollection()->addAction("zoom-reset", d_ptr->m_ZoomReset);
